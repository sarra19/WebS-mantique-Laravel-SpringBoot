...
<head>
    <meta name="description" content="Create a new category in the system.">
    <meta property="og:title" content="Create Category">
...
<body class="app sidebar-mini">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="bi bi-folder-plus"></i> Create Category</h1>
                ...
                <form id="categoryForm" action="{{ route('category.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-3">
                            ...
                            <textarea class="form-control" id="category_description" name="category_description" placeholder="Enter category description" rows="3">{{ old('category_description') }}</textarea>
                        </div>
                    </div>
